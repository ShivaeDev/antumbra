...
import type { PortServices } from "@antumbra/platform-feature/port.ts";
...
export function serving<const Features extends readonly FeatureShape[]>(
	...
	Rpc.ToHandler<Rpcs<Features>> | Token,
	never,
	Commit | PortServices<Features[number]["queries"][number]["ports"]> | Live | ServerToken
>;
