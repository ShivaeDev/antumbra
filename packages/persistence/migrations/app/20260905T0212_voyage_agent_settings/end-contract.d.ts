...
export type StorageHash =
  StorageHashBase<'sha256:20aa9a5ed5d2a4ba6fa91604a2cbea2f36650ebc73518c2b698db48dc0e10004'>;
...
export type FieldOutputTypes = {
  readonly __unbound__: {
    ...
    readonly BackendCapacity: {
      readonly backend: CodecTypes['sqlite/text@1']['output'];
      readonly status: CodecTypes['sqlite/text@1']['output'];
      readonly reason: CodecTypes['sqlite/text@1']['output'] | null;
      readonly detail: CodecTypes['sqlite/text@1']['output'] | null;
      readonly observedAt: CodecTypes['sqlite/datetime@1']['output'];
      readonly resetsAt: CodecTypes['sqlite/datetime@1']['output'] | null;
      readonly utilization: CodecTypes['sqlite/real@1']['output'] | null;
      readonly updatedAt: CodecTypes['sqlite/datetime@1']['output'];
    };
    readonly Berth: {
      readonly id: CodecTypes['sqlite/text@1']['output'];
    ...
    readonly RulingReclassification: {
      ...
      readonly byAgentId: CodecTypes['sqlite/text@1']['output'] | null;
    ...
    readonly Voyage: {
      ...
      readonly captainModel: CodecTypes['sqlite/text@1']['output'] | null;
      readonly captainEffort: CodecTypes['sqlite/text@1']['output'] | null;
      readonly crewBackend: CodecTypes['sqlite/text@1']['output'];
      readonly crewModel: CodecTypes['sqlite/text@1']['output'] | null;
      readonly crewEffort: CodecTypes['sqlite/text@1']['output'] | null;
      readonly createdAt: CodecTypes['sqlite/datetime@1']['output'];
    };
...
export type FieldInputTypes = {
  readonly __unbound__: {
    ...
    readonly BackendCapacity: {
      readonly backend: CodecTypes['sqlite/text@1']['input'];
      readonly status: CodecTypes['sqlite/text@1']['input'];
      readonly reason: CodecTypes['sqlite/text@1']['input'] | null;
      readonly detail: CodecTypes['sqlite/text@1']['input'] | null;
      readonly observedAt: CodecTypes['sqlite/datetime@1']['input'];
      readonly resetsAt: CodecTypes['sqlite/datetime@1']['input'] | null;
      readonly utilization: CodecTypes['sqlite/real@1']['input'] | null;
      readonly updatedAt: CodecTypes['sqlite/datetime@1']['input'];
    };
    readonly Berth: {
      readonly id: CodecTypes['sqlite/text@1']['input'];
    ...
    readonly RulingReclassification: {
      ...
      readonly byAgentId: CodecTypes['sqlite/text@1']['input'] | null;
    ...
    readonly Voyage: {
      ...
      readonly captainModel: CodecTypes['sqlite/text@1']['input'] | null;
      readonly captainEffort: CodecTypes['sqlite/text@1']['input'] | null;
      readonly crewBackend: CodecTypes['sqlite/text@1']['input'];
      readonly crewModel: CodecTypes['sqlite/text@1']['input'] | null;
      readonly crewEffort: CodecTypes['sqlite/text@1']['input'] | null;
      readonly createdAt: CodecTypes['sqlite/datetime@1']['input'];
    };
    readonly VoyageAgent: {
        ...
        readonly entries: {
          readonly table: {
            ...
            readonly backendCapacity: {
              ...
              primaryKey: { readonly columns: readonly ['backend'] };
              uniques: readonly [];
              indexes: readonly [];
              foreignKeys: readonly [];
            };
              ...
              foreignKeys: readonly [
                ...
                },
                {
                  readonly source: {
                    readonly namespaceId: '__unbound__' & NamespaceId;
                    readonly tableName: 'ruling';
                    readonly columns: readonly ['ruledByAgentId'];
                  };
                  readonly target: {
                    readonly namespaceId: '__unbound__' & NamespaceId;
                    readonly tableName: 'agent';
              ...
              foreignKeys: readonly [
                ...
                },
                {
                  readonly source: {
                    readonly namespaceId: '__unbound__' & NamespaceId;
                    readonly tableName: 'rulingReclassification';
                    readonly columns: readonly ['byAgentId'];
                  };
                  readonly target: {
                    readonly namespaceId: '__unbound__' & NamespaceId;
                    readonly tableName: 'agent';
            ...
            readonly voyage: {
              columns: {
                ...
                readonly captainModel: {
                  readonly nativeType: 'text';
                  readonly codecId: 'sqlite/text@1';
                  readonly nullable: true;
                };
                readonly captainEffort: {
                  readonly nativeType: 'text';
                  readonly codecId: 'sqlite/text@1';
                  readonly nullable: true;
                };
...
> & {
  ...
  readonly roots: {
    ...
    readonly backendCapacity: {
      readonly namespace: '__unbound__' & NamespaceId;
      readonly model: 'BackendCapacity';
    };
      ...
      readonly __unbound__: {
        readonly models: {
          readonly Agent: {
            ...
            readonly relations: {
              ...
              readonly rulingMoves: {
                ...
                readonly on: {
                  readonly localFields: readonly ['id'];
                  readonly targetFields: readonly ['byAgentId'];
                };
              };
              ...
              readonly rulingVerdicts: {
                ...
                readonly on: {
                  readonly localFields: readonly ['id'];
                  readonly targetFields: readonly ['ruledByAgentId'];
                };
              };
              readonly rulings: {
                readonly to: {
          ...
          readonly BackendCapacity: {
            ...
            readonly relations: Record<string, never>;
            readonly storage: {
              readonly table: 'backendCapacity';
              readonly namespaceId: '__unbound__';
              readonly fields: {
                readonly backend: { readonly column: 'backend' };
                readonly status: { readonly column: 'status' };
                ...
                readonly resetsAt: { readonly column: 'resetsAt' };
                readonly utilization: { readonly column: 'utilization' };
                readonly updatedAt: { readonly column: 'updatedAt' };
              };
            };
          };
          ...
          readonly Ruling: {
            ...
            readonly relations: {
              ...
              readonly ruledByAgent: {
                ...
                readonly cardinality: 'N:1';
                readonly on: {
                  readonly localFields: readonly ['ruledByAgentId'];
                  readonly targetFields: readonly ['id'];
                };
              };
              readonly subjects: {
          ...
          readonly RulingReclassification: {
            ...
            readonly relations: {
              readonly byAgent: {
                ...
                readonly cardinality: 'N:1';
                readonly on: {
                  readonly localFields: readonly ['byAgentId'];
                  readonly targetFields: readonly ['id'];
                };
              };
              readonly ruling: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly byAgentId: { readonly column: 'byAgentId' };
                readonly radius: { readonly column: 'radius' };
                readonly urgency: { readonly column: 'urgency' };
          ...
          readonly Voyage: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly captainModel: { readonly column: 'captainModel' };
                readonly captainEffort: { readonly column: 'captainEffort' };
                readonly crewBackend: { readonly column: 'crewBackend' };
                readonly crewModel: { readonly column: 'crewModel' };
                readonly crewEffort: { readonly column: 'crewEffort' };
                readonly createdAt: { readonly column: 'createdAt' };
              };
            };
          };
