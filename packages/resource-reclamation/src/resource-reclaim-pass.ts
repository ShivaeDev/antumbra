...
import type { ResourceReclaimState } from "@antumbra/platform-vocabulary/agent-runtime/statuses.ts";
import { decodeStoredResourceReclaimState } from "@antumbra/platform-vocabulary/agent-runtime/stored.ts";
