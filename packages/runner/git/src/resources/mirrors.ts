...
import { Machine, pathExists } from "#resources/machine.ts";
import type { BerthPlan, RunnerError } from "#resources/model.ts";

export const ensureMirror = (reposRoot: string, berth: BerthPlan): Effect.Effect<string, RunnerError, GitProcess | Machine> =>
	Effect.gen(function* () {
