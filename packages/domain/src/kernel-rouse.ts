...
// meeting a wake already parked in waiting pushes that one rather than stacking
// a second demand behind it — the blocker it named may have cleared since, and
// nothing else in the system will ever ask again.
