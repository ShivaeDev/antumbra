...
import { type BerthSite, type ChangePreparationEvidence, type RunnerError, RunnerProvisionConflict } from "@antumbra/plugin-api";
import { Effect } from "effect";
import { canonicalPath } from "#adapters/fs.ts";
import { runGit } from "#git-runtime.ts";

export const captureChange = (berth: BerthSite): Effect.Effect<ChangePreparationEvidence, RunnerError> =>
	Effect.gen(function* () {
