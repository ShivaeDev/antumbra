...
it.effect("draws a voyage snapshot as its chart, work, and board", () =>
	Effect.gen(function* () {
		...
		yield* react(() =>
			root.render(<VoyagePanel fleet={undefined} onError={() => undefined} onPiece={() => undefined} piece={undefined} voyageId="voyage-1" />),
		);
...
it.effect("another voyage is another subscription and another picture", () =>
	Effect.gen(function* () {
		...
		yield* react(() =>
			root.render(<VoyagePanel fleet={undefined} onError={() => undefined} onPiece={() => undefined} piece={undefined} voyageId="voyage-2" />),
		);
