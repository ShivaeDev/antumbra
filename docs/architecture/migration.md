...
| `boards`                                                            | the board entry and writing to it are a domain at `packages/server/domains/boards`; the `Boards` seam, the mail half and the pure summaries stay until mail and smoothing move | in progress |
