...
Before writing or reviewing code, apply `quality-gates/simplicity.md` — reject
complexity that does not pay for itself with a current need.
...
Comments are exceptional and never narrate; `why:` is not repository style.
