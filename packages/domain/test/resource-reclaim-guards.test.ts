...
it.live("prepare, open authorization, adoption, and observation reject a claim", () =>
	Effect.gen(function* () {
		...
		}).pipe(Effect.provide(domainKernelLayer(temporary, backend.backend, {}, passiveRunner, changeHostsOf(host.host))));
	}),
);
