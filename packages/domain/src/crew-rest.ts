...
const openRootsOf = (world: ExecutionWorld, agentId: string): ReadonlyArray<AgentSessionRow> =>
...
export const restingCrew = (world: ExecutionWorld, runtime: CrewRuntime): ReadonlyMap<string, ReadonlyArray<string>> =>
	new Map(
...
export const retirableCrew = (world: ExecutionWorld, runtime: CrewRuntime): ReadonlySet<string> =>
	new Set(
		[...world.agentStatus].flatMap(([agentId, status]) =>
...
export const claimedCrew = (world: ExecutionWorld, pieceId: string): ReadonlyArray<string> =>
