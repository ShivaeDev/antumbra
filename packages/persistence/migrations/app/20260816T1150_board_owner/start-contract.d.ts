...
export type StorageHash =
  StorageHashBase<'sha256:c1592916ef1d124550d8c5c333cab0ffedabe62ddd9c0edd6b44cb473a9451dc'>;
        ...
        readonly entries: {
          readonly table: {
            ...
            readonly agentBoard: {
              ...
              primaryKey: { readonly columns: readonly ['agentId', 'boardId'] };
              uniques: readonly [];
              indexes: readonly [];
              foreignKeys: readonly [];
            };
            ...
            readonly change: {
              ...
              primaryKey: { readonly columns: readonly ['id'] };
              uniques: readonly [{ readonly columns: readonly ['host', 'repoId', 'externalId'] }];
              indexes: readonly [
            ...
            readonly pieceBoard: {
              ...
              primaryKey: { readonly columns: readonly ['pieceId', 'boardId'] };
              uniques: readonly [];
              indexes: readonly [];
              foreignKeys: readonly [];
            };
            ...
            readonly voyageBoard: {
              ...
              primaryKey: { readonly columns: readonly ['voyageId', 'boardId'] };
              uniques: readonly [];
              indexes: readonly [];
              foreignKeys: readonly [];
            };
...
> & {
  ...
  readonly roots: {
    ...
    readonly voyageBoard: {
      readonly namespace: '__unbound__' & NamespaceId;
      readonly model: 'VoyageBoard';
    };
    readonly pieceBoard: {
      readonly namespace: '__unbound__' & NamespaceId;
      readonly model: 'PieceBoard';
    };
    readonly agentBoard: {
      readonly namespace: '__unbound__' & NamespaceId;
      readonly model: 'AgentBoard';
    };
  };
  readonly domain: {
    readonly namespaces: {
