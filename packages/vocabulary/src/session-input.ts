...
export const SessionInputId = Schema.String.check(Schema.isUUID()).pipe(
	Schema.brand("SessionInputId"),
);
export type SessionInputId = typeof SessionInputId.Type;

export const SessionImageMediaType = Schema.Literals([
	"image/jpeg",
	"image/png",
	"image/webp",
]);
...
export const SessionInputPosition = Schema.Number.check(
	Schema.isInt(),
