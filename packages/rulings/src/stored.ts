...
} from "@antumbra/platform-vocabulary/ruling.ts";
...
export const storedAnswer = Effect.fnUntraced(function* (row: StoredRuling) {
...
export const storedReclassification = Effect.fnUntraced(function* (rulingId: string, row: StoredRulingReclassification) {
	return {
		at: row.at,
