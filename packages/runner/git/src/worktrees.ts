...
export const countUnpushedBranchCommits = Effect.fn("Git.countUnpushedBranchCommits")(
	(mirror: string, branch: string): Effect.Effect<number, GitError, GitProcess> => countUnpushedCommits(mirror, branch, "inspect-branch"),
);

export const addWorktree = Effect.fn("Git.addWorktree")(
	(mirror: string, path: string, branch: string, ref: string): Effect.Effect<void, GitError, GitProcess> =>
		runGit({
...
export const addExistingWorktree = Effect.fn("Git.addExistingWorktree")(
	(mirror: string, path: string, branch: string): Effect.Effect<void, GitError, GitProcess> =>
		runGit({
...
export const inspectWorktree = Effect.fn("Git.inspectWorktree")(function* (path: string): Effect.fn.Return<WorktreeState, GitError, GitProcess> {
...
export const removeWorktree = Effect.fn("Git.removeWorktree")(
	(mirror: string, path: string): Effect.Effect<void, GitError, GitProcess> =>
		runGit({
...
export const pruneWorktrees = Effect.fn("Git.pruneWorktrees")(
	(mirror: string): Effect.Effect<void, GitError, GitProcess> =>
		runGit({
...
export const deleteBranch = Effect.fn("Git.deleteBranch")(
	(mirror: string, branch: string): Effect.Effect<void, GitError, GitProcess> =>
		runGit({
