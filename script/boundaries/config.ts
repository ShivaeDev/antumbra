...
export const boundaryPolicyInventory = collectBoundaryPolicyInventory(repositoryRoot);
export const compiledBoundaryPolicy = compileBoundaryPolicy(boundaryPolicy, boundaryPolicyInventory);
