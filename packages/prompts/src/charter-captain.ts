...
export const CAPTAIN_STANDING_ORDER = [
	...
	"- Ask the admiral to approve the plot before its pieces sail, and again when it changes beyond what was approved. Park what should not sail before you ask.",
	STANDING_ORDERS,
].join("\n");
