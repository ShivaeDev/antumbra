...
[`DESIGN.md`](../../DESIGN.md) owns Antumbra's cross-context axioms. These guides own the relationships, acts, rationale, and recovery behavior within
each bounded topic. [`GLOSSARY.md`](../../GLOSSARY.md) is the short product- language index that routes readers here; code and schemas own exact
implemented fields, states, and wire names.

- [Work and planning](work-and-planning.md) — authority, Voyages, course revision, Pieces, dependencies, and progress.
...
- [Charters](charters.md) — what each Agent needs at open, wake and steering, the boundary with tool descriptions, and compaction research.
