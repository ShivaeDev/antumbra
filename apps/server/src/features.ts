...
export const features = [roleSettings, backends, settings, voyages, pieces, mail, boards, repos, reports, artifacts, capacity, reclamation, sessions, agents, inputs, starts, changes, rulings] as const;
