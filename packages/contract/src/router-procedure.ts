...
import type { CostSource } from "#costs/source.ts";
...
export type AppRuntime = EffectTRPCRuntime<
	AppInfoSource | AppLifecycleSource | CostSource | HoldSource | RulingSource | SettingsSource | SightSource | VoyageSource | WindowSource,
	never
>;
