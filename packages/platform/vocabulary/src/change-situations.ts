...
export const mergeConflicts = (input: MergeConflicts): string =>
...
export const checksFailed = (input: ChecksFailed): string =>
...
export const unresolvedReviews = (input: UnresolvedReviews): string =>
