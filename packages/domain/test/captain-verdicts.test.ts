...
it.live("a captain is refused a question that would bind the fleet", () =>
	withLadder((ladder) =>
		Effect.gen(function* () {
...
it.live("a question a captain passes up becomes the flagship's", () =>
	withLadder((ladder) =>
		Effect.gen(function* () {
			const asked = yield* ask("fleet", "captain");
...
it.live("a question that climbed past a captain is no longer its own", () =>
	withLadder((ladder) =>
		Effect.gen(function* () {
			const asked = yield* ask("voyage", "captain");
...
it.live("a pass-up with nothing to say is refused", () =>
	withLadder((ladder) =>
		Effect.gen(function* () {
			const asked = yield* ask("voyage", "captain");
