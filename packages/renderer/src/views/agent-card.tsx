...
import { Card, CardAction, CardContent, CardDescription, CardHeader } from "#components/ui/card.tsx";
...
export const AgentCard = ({
	...
	<Card>
		<CardHeader>
			...
			<div className="min-w-0 text-sm font-medium wrap-anywhere">{agent.role}</div>
			<CardDescription className="line-clamp-2 wrap-anywhere">{agent.charter}</CardDescription>
			{agent.canRetire ? (
				<CardAction>
