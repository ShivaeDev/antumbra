...
export const cloneMirror = (source: string, destination: string): Effect.Effect<void, GitError, GitProcess> =>
	runGit({
...
export const refreshMirror = Effect.fn("Git.refreshMirror")(function* (path: string): Effect.fn.Return<void, GitError, GitProcess> {
	yield* runGit({
