...
export const kernelLayer = (temporary: TemporaryPersistence, options: KernelOptions) => KernelLive(options).pipe(Layer.provideMerge(temporary.layer));

export const statusesUntilTerminal = <E, R>(changes: Stream.Stream<IntentStatus, E, R>) =>
