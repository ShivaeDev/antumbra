...
export const setCaptainBackend = (
	request: VoyageBackendRequest,
	onError: OnError,
): void => fired(client.setCaptainBackend.mutate(request), onError);

export const setCrewBackend = (
	request: VoyageBackendRequest,
	onError: OnError,
): void => fired(client.setCrewBackend.mutate(request), onError);
