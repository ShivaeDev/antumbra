...
export type ConsoleGlass = Glass<readonly [typeof roleSettings, typeof backends, typeof settings, typeof voyages, typeof pieces]>;
...
export const consoleGlass = (reach: Reach): ConsoleGlass => connect([roleSettings, backends, settings, voyages, pieces], reach);
