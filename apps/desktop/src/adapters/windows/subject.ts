...
// the same rule, and there is one of it. Every role names its own subject
// here, so a role added to the union is held to both by having been taught to
// say what it is about, and nowhere else.
