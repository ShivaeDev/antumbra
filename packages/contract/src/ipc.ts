...
const _bindSubscribe = (request: SubscribeRequest): BridgeSubscribeRequest =>
	request;
const _bindFailureCodeToTrpc = (code: TrpcFailureCode): TRPC_ERROR_CODE_KEY =>
	code;
const _bindFailureCodeFromTrpc = (code: TRPC_ERROR_CODE_KEY): TrpcFailureCode =>
	code;
const _bindInvokeTypeToTrpc = (type: TrpcInvokeType): TrpcInvokeProcedureType =>
	type;
const _bindInvokeTypeFromTrpc = (
	type: TrpcInvokeProcedureType,
): TrpcInvokeType => type;
void _bindRequest;
void _bindSubscribe;
