...
export const vocabularySurfacePolicy = [
	vocabularyAccess("agent-tools-uses-board-and-ruling-vocabulary")
		...
		.demonstratedBy({
			illegal: importFrom(files.inPackage("agent-tools", "src/tool.ts")).to(files.inPackage("vocabulary", "src/change.ts")),
			legal: importFrom(files.inPackage("agent-tools", "src/tool.ts")).to(files.inPackage("vocabulary", "src/board.ts")),
		}),
	vocabularyAccess("agent-backends-use-session-event-vocabulary")
		...
		.demonstratedBy({
			illegal: importFrom(files.inPackage("backend-codex", "src/backend.ts")).to(files.inPackage("vocabulary", "src/change.ts")),
			legal: importFrom(files.inPackage("backend-codex", "src/backend.ts")).to(files.inPackage("vocabulary", "src/session-events.ts")),
		}),
	vocabularyAccess("plugin-api-uses-port-vocabulary")
		...
		.demonstratedBy({
			illegal: importFrom(files.inPackage("plugin-api", "src/port.ts")).to(files.inPackage("vocabulary", "src/board.ts")),
			legal: importFrom(files.inPackage("plugin-api", "src/port.ts")).to(files.inPackage("vocabulary", "src/change.ts")),
		}),
	vocabularyAccess("renderer-uses-session-event-vocabulary")
		...
		.allowsOnly("session-events")
		.demonstratedBy({
			illegal: importFrom(files.inPackage("renderer", "src/view.ts")).to(files.inPackage("vocabulary", "src/change.ts")),
			legal: importFrom(files.inPackage("renderer", "src/view.ts")).to(files.inPackage("vocabulary", "src/session-events.ts")),
		}),
