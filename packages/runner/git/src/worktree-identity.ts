...
export const branchExists = (mirror: string, branch: string): Effect.Effect<boolean, GitError, GitProcess> =>
	runGit({
...
export const inspectWorktreeIdentity = (path: string): Effect.Effect<WorktreeIdentity, GitError, GitProcess> =>
	runGit({
