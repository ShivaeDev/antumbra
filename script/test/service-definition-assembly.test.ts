...
`);
	...
	it("supports renamed imports and rejects namespace imports", () => {
		expect(
			violationsIn(`
import { defineService as define } from "@antumbra/platform-service-definition/define-service.ts";
import { Effect as Fx } from "effect";
export const Example = define({
	id: "@antumbra/example/Example",
	initialize: Fx.void,
...
`),
		...
		expect(
			violationsIn(`
import * as Services from "@antumbra/platform-service-definition/define-service.ts";
